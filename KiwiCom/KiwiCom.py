...
def process_kiwi(in_url, in_webdriver_path, in_excel_name):
    ...
    kiwi_instance = KiwiCom(in_url, in_webdriver_path)
    ...
    element_cards_table = WebDriverWait(kiwi_instance.driver, 10).until(
        EC.presence_of_element_located((By.CSS_SELECTOR, "#react-view > div > div.orbit-box.font-base.box-border.bg-cloud-light.grow-\[var\(--box-grow\)\] > div > div > div > div > div > div.min-w-0.flex-grow.p-md.de\:p-0.de\:pb-lg.de\:ps-lg.de\:pt-lg > div > div > div:nth-child(3) > div > div")))
...
#Fly criteria
airport_start = "katowice-polska"
#airport_start = "katowice-polska,krakow-polska"
airport_end = "malaga-hiszpania"

#Luty
datetime_start =  datetime.datetime.strptime("05.02.2024", "%d.%m.%Y")
datetime_end =  datetime.datetime.strptime("20.02.2024", "%d.%m.%Y")
#Marzec
datetime_start =  datetime.datetime.strptime("16.03.2024", "%d.%m.%Y")
datetime_end =  datetime.datetime.strptime("07.04.2024", "%d.%m.%Y")
