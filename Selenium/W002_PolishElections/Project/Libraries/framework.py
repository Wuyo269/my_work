...
class FrameWork():
    ...
    CONFIG_FILE_PATH = r"Config/Config2.xlsx"
    ...
    def read_config_file(self):
        try:
            ...
            raise Exception(f"{self.LOGGING_MARKER} Method 'read_config_file' fails - {error_message}") from error_message
    ...
    def upgrade_config_file(self):
        try:
            ...
            raise Exception(f"{self.LOGGING_MARKER} Method 'upgrade_config_file' fails - {error_message}") from error_message
    ...
    def get_process_time(self) -> str:
        try:
            ...
            raise Exception(f"{self.LOGGING_MARKER} Method 'get_process_time' fails - {error_message}") from error_message
