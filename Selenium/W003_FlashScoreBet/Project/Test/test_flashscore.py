...
class FlashScore():
    ...
    def get_dict_of_next_round(self) -> dict:
        """
        Information about next round are presented on the bottom of the page.
        Get those information and return in the form of dictionary
        :return:
        dict_next_round [Team] = next game date
        """
        next_round = self.map_element_with_wait(By.CSS_SELECTOR, self.NEXT_ROUND_CSS_SELECTOR_NAME)
        ...
        for game in next_round_split:
            ...
            for team in teams:
                team = team.strip()
                # Team mights have more than 1 game. Get only the closest one
                if not team in dict_next_round:
                    dict_next_round[team.strip()] = current_date

        return dict_next_round
    ...
    def get_main_table_data(self) -> object:
        ...
        # Get information about next game date
        dict_next_round = self.get_dict_of_next_round()
        ...
        for row in element_rows:
            ...
            CSS_SELECTOR = r"body > div:nth-child(10) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > main:nth-child(2) > div:nth-child(5) > div:nth-child(2) > div:nth-child(9) > div:nth-child(4) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(10) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > span:nth-child(3)"

            tooltip1 = r"body > div:nth-child(10) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > main:nth-child(2) > div:nth-child(5) > div:nth-child(2) > div:nth-child(9) > div:nth-child(4) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(10) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > strong:nth-child(1)"
            try:
                #next_game_text = dict_next_round[club_name]
                #next_game_text = dict_next_round[club_name]
                next_game_text = self.map_element(row, By.CLASS_NAME, self.TABLE_CELL_FORM_ICON_TBD)
                actions.move_to_element(next_game_text).perform()
